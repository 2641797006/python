...
def msgbox_func():
    while True:
        while msgbox_list:
            ctypes.windll.user32.MessageBoxTimeoutW(0, msgbox_list[0], 'New Message', win32con.MB_ICONWARNING | win32con.MB_SYSTEMMODAL, 0, 1000)
            del msgbox_list[0]
        time.sleep(0.3)
...
def main(argv):
    ...
    try:
        ...
        t_msgbox = Thread(target=msgbox_func)
